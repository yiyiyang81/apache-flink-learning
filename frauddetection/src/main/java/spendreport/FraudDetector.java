...
public class FraudDetector extends KeyedProcessFunction<Long, Transaction, Alert> {
	...
	// ValueState is a always scoped to the current key
	...
	public void processElement(
		...
		// Can request direclty the flagState since the flagState is a keyed state and the key is available in the context
